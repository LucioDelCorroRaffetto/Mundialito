...
// Hard cap: incluso un knockout con tiempo extra + penales termina antes
// de 3h. Más allá de eso, casi seguro el feed nunca publicó el FT, no que
// el partido sigue de verdad.
//
// HABÍA un fast-path a las 2h gateado por "hay evento en period≥2 minuto≥90"
// pero un partido normal entra a minuto 90 a las 1h45m, y los goles del
// descuento se cargan minutos después de que disparemos el flip. Resultado:
// FRA-SEN se cerró 2-0 cuando terminó 3-1 (los 2 goles del 90+ entraron
// después del flip). Mantenemos solo el cap duro de 3h30m.
