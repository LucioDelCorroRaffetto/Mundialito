...
import { leagueTournamentPicksHandler } from './handlers/tournament-picks.js';
...
leaguesRouter.get('/:id/tournament-predictions', (req, res, next) =>
  leagueTournamentPicksHandler(req, res).catch(next)
);
