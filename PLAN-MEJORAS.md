...
| 2026-07-02 | Sesión 2 — Celebración + leaderboard animado | `feat/sesion-2-celebracion-leaderboard` (8d948bd) + fix `7d63a75`, mergeadas a main y deployadas | ✅ Validado en prod por el usuario: toast "¡Acertaste! +N" / "¡Exacto! +N" dispara correctamente. Bug encontrado y corregido: el confetti/glow estaba montado sobre la card "Tu pronóstico", que queda debajo del timeline de eventos en partidos live/finished — invisible sin scrollear. Se movió a la score card de arriba (siempre visible sin scroll, commit `7d63a75`). Pendiente confirmar visualmente el confetti/glow ya reubicados y el reorder animado del leaderboard/standings. |
